import { createLogger, _ } from 'Imports'
const logger = createLogger('brendens-game-locations')

import { IItem } from 'apps/BrendensAdventure/game/items'
...
export function initLocations() {
  let locations: ILocation[] = [
    ...
    },
    {
      ...
      directions: [
        { id: 'you die...', toLocationId: '_restart' },
      ],
    },
    {
      id: 'forest entrance',
      desc: 'You come across the entrance to a dark and forbidding forest. A chill wind blows.',
      directions: [
        { id: 'small path', toLocationId: 'road' },
        {
          ...
          action: (inventory: IItem[]) => {
            ...
            logger.x(sword)
            logger.x(shield)
            if (sword && sword.isEquipped === true && shield && shield.isEquipped === true) {
              return 'forest'
            }
    ...
    },
    {
      ...
      directions: [
        { id: 'Victory!', toLocationId: '_restart' },
      ],
    },
    {
      id: 'old castle',
    ...
    },
    {
      ...
      directions: [
        { id: 'exit to castle', toLocationId: 'old castle' },
      ],
      shop: [
        { id: 'shield', cost: 2 },
    ...
    },
    {
      ...
      directions: [
        { id: 'start over', toLocationId: 'road' },
      ],
    },
  ]
  return locations
